...
{
    public static class CryptoAgent
    {
        ...
        {
            197, 100, 8, 139, 252, 54, 132, 189, 112, 126, 43, 116, 152, 241, 88, 152, 48, 193, 105, 146, 255, 192, 28,
            116, 138, 47, 79, 31, 160, 188, 105, 32
        };

        private static readonly byte[] _authKey =
        {
            63, 162, 173, 40, 57, 17, 232, 170, 27, 184, 230, 124, 252, 237, 248, 188, 63, 188, 54, 180, 121, 65, 10,
            140, 79, 18, 215, 182, 226, 30, 54, 33
        };
            ...
            byte[] nonSecretPayload = null)
        {
            ...
            var plainText = Encoding.UTF8.GetBytes(secretMessage);
            var cipherText = SimpleEncrypt(plainText, _cryptKey, _authKey, nonSecretPayload);
            return Convert.ToBase64String(cipherText);
        }
            ...
            int nonSecretPayloadLength = 0)
        {
            ...
            var cipherText = Convert.FromBase64String(encryptedMessage);
            var plainText = SimpleDecrypt(cipherText, _cryptKey, _authKey, nonSecretPayloadLength);
            return plainText == null ? null : Encoding.UTF8.GetString(plainText);
        }
